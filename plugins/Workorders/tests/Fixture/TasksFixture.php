...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'task_type_id' => ['type' => 'index', 'columns' => ['task_type_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'tasks_ibfk_1' => ['type' => 'foreign', 'columns' => ['task_type_id'], 'references' => ['task_types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
