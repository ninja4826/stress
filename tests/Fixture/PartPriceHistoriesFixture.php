...
/**
 * PartPriceHistoriesFixture
 *
 */
class PartPriceHistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'part_price_histories_ibfk_1' => ['type' => 'foreign', 'columns' => ['part_vendor_id'], 'references' => ['part_vendors', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            'id' => 1,
            'part_vendor_id' => 1,
            'date_changed' => '2015-03-31 11:19:27',
            'price' => ''
        ],
    ];
}
